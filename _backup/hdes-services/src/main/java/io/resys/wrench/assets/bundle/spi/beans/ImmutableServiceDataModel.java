...
public class ImmutableServiceDataModel implements ServiceDataModel {
  ...
  private final List<TypeDef> params;
  ...
  public ImmutableServiceDataModel(
      ...
      ServiceStatus status, List<ServiceError> errors, List<TypeDef> params, List<ServiceAssociation> associations) {
    this.id = id;
    this.name = name;
