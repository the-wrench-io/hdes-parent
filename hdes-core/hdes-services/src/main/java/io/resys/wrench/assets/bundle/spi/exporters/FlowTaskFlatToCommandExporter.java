...
public class FlowTaskFlatToCommandExporter {
  ...
  public void build(String location, String name) {
    ScriptFlatToCommandBuilder commandBuilder = new ScriptFlatToCommandBuilder(objectMapper());


    try {
      for(Resource resource : resolver.getResources("classpath*:assets/flowtask/**")) {
        ...
        String fileName = location + "/assets/flowtask/" + resource.getFilename();
