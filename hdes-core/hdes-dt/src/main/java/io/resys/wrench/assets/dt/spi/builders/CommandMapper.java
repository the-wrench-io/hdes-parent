...
public class CommandMapper {
  ...
  public static class Builder {
    ...
    private Supplier<DynamicValueExpressionExecutor> dynamicValueExpressionExecutor;
    ...
    private final Map<ValueType, List<String>> headerExpressions = new HashMap<>();
    ...
    public Builder headerTypes(Collection<String> headerTypes) {
      this.headerTypes.addAll(headerTypes);
      return this;
    }
    public Builder expressionBuilder(Supplier<DecisionTableExpressionBuilder> expressionBuilder) {
      this.expressionBuilder = expressionBuilder;
      return this;
    }
    public Builder dynamicValueExpressionExecutor(Supplier<DynamicValueExpressionExecutor> dynamicValueExpressionExecutor) {
      this.dynamicValueExpressionExecutor = dynamicValueExpressionExecutor;
      return this;
    }
    public Builder headerExpressions(Map<ValueType, List<String>> headerExpressions) {
