...
public class HdesDocumentStore extends PersistenceCommands implements HdesStore {
  private static final Logger LOGGER = LoggerFactory.getLogger(HdesDocumentStore.class);
  ...
  public StoreRepoBuilder repo() {
    return new StoreRepoBuilder() {
      ...
      public HdesStore build() {
        HdesAssert.notNull(repoName, () -> "repoName must be defined!");
        return new HdesDocumentStore(ImmutableThenaConfig.builder()
            .from(config)
            .repoName(repoName)
  ...
  public static class Builder {
    ...
    public HdesDocumentStore build() {
      HdesAssert.notNull(repoName, () -> "repoName must be defined!");
      
      if(LOGGER.isDebugEnabled()) {
        final var log = new StringBuilder()
          .append(System.lineSeparator())
          .append("Configuring Thene: ").append(System.lineSeparator())
      ...
      final ThenaConfig config = ImmutableThenaConfig.builder()
          .client(thena).repoName(repoName).headName("main")
