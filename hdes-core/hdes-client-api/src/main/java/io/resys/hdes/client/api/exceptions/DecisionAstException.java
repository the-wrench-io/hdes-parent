...
public class DecisionAstException extends AstException {

  private static final long serialVersionUID = -7154685569622201632L;

  private final AstCommand command;

  public DecisionAstException(AstCommand command, String message, Throwable cause) {
    super(message, cause);
  ...
  public DecisionAstException(AstCommand command, String message) {
    super(message);
    this.command = command;
  }
