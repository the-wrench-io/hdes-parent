...
public class ImmutableServiceDataParamModel implements ServiceDataParamModel {

  private static final long serialVersionUID = -3494498278287692703L;

  private final ServiceParamType contextType;
  private final AstDataType type;
  private final int order;

  public ImmutableServiceDataParamModel(int order, AstDataType type, ServiceParamType contextType) {
    super();
    this.type = type;
