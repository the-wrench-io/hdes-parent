...
public class FlowStepEndFinder implements FlowStepVisitor<FlowStepEndSpec, FlowStepEndSpec>, FlowMappingDefVisitor<TypeDef, TypeDef> {
  ...
  public FlowStepEndSpec visitEndPointer(EndPointer pointer, HdesTree ctx) {
    return ImmutableFlowStepEndSpec.builder().addValues(visitBody(pointer, ctx)).build();
  }
