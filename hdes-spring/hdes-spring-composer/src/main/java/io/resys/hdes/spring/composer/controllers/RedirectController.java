...
public class RedirectController {
  ...
  private final ComposerConfigBean configBean;

  public RedirectController(ComposerConfigBean configBean) {
    super();
  ...
  public String index() {
    return "redirect:/" + FileUtils.cleanPath(configBean.getIdeContextPath()) + "/";
  }
}
