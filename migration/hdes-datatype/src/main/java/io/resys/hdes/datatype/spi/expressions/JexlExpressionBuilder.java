...
import io.resys.hdes.datatype.spi.expressions.operations.JexlOperation;

public class JexlExpressionBuilder implements DataTypeService.ExpressionBuilder {
  ...
  public Expression build() {
    ...
    try {
      return ImmutableExpression.builder()
          .operation(new JexlOperation(src))
          .src(src)
          .type(valueType)
          .srcType(ExpressionSourceType.JEXL)
          //.constants(constants)
          .build();
