...
import io.resys.hdes.storage.mongodb.codecs.ChangesCodecProvider;
...
public class MongoDbConfig {
  ...
  public static void client(Consumer<MongoClient> consumer) {
    MongoDbConfig config = new MongoDbConfig();
    try {
      config.setUp();
      consumer.accept(config.getClient());
    } finally {
      config.tearDown();
    }
  }
