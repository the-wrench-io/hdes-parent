package io.resys.hdes.decisiontable.tests.config;
...
public class TestDtConfig {
  ...
  public static final DecisionTableService decisionTableRepository = GenericDecisionTableService.config().dataType(dataTypeService).build();
}
