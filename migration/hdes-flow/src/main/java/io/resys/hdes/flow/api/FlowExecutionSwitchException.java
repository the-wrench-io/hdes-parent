...
public class FlowExecutionSwitchException extends HdesException {
  private static final long serialVersionUID = -3057343235911345568L;

  public FlowExecutionSwitchException(String message, Exception e) {
    super(message, e);
  }
  ...
  public static class Builder {
    ...
    public FlowExecutionSwitchException build() {
      ...
      return new FlowExecutionSwitchException(message, original);
    }
  }
}
