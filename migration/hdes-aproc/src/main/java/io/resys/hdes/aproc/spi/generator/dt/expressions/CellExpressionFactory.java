...
public interface CellExpressionFactory {
  ...
  public static String create(Header header, Cell cell) {
    ...
    switch (valueType) {
    case STRING:
      return CellExpressionString.builder(OBJECT_MAPPER).build(src, header.getName());
    case BOOLEAN:
      return CellExpressionBoolean.builder().build(src, header.getName());
    case INTEGER:
    case LONG:
    case DECIMAL:
      return CellExpressionNumber.builder().build(src, valueType, header.getName());
    case DATE:
    case DATE_TIME:
      return CellExpressionDate.builder().build(src, valueType, header.getName());
    default:
