...
public class NestedParamAccessNode implements DataAccessNode {
  ...
  private NestedParamAccessNode(Map<String, Serializable> entries) {
    super();
  ...
  public static NestedParamAccessNode create(Map<String, Serializable> entries) {
    Assertions.notNull(entries, () -> "entries can't be null!");
    return new NestedParamAccessNode(entries);
  }
  ...
  public static class Builder {
    ...
    public NestedParamAccessNode build() {
      return new NestedParamAccessNode(entries);
    }
  }
