...
public class HdesReProjectsResourceHandler extends HdesResourceEditorHandler {

  public HdesReProjectsResourceHandler(
  ...
  @Override
  protected void handleResource(RoutingContext event, HttpServerResponse response, HdesResourceEditorContext ctx) {
